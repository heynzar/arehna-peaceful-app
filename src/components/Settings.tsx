...
export default function Settings() {
  ...
  return (
    ...
    >
      <div className="relative p-4 w-full max-w-[496px] scale-110 rounded-2xl bg-neutral-900 border border-white/15">
        <button
          onClick={() => {
            setOpenSettings(false);
          }}
          className="bg-neutral-800 p-1 rounded-lg ml-auto absolute right-4 top-4"
        >
        ...
        <div className="flex flex-col">
          <div className="mt-2">
            ...
            <div className="my-2 flex justify-between items-center bg-neutral-800 py-1 px-2 rounded-lg">
              <span className="text-sm opacity-80">Toggole Hijri Date</span>
              <div
                onClick={() => setHijriDate(!hijriDate)}
                className="w-9 cursor-pointer rounded-full p-0.5 bg-neutral-900"
              >
                <div
                  className={`${
                    hijriDate ? "bg-sky-400 translate-x-4" : "bg-neutral-600"
          ...
          <div className="mb-4 flex justify-between items-center bg-neutral-800 py-1 px-2 rounded-lg">
            ...
            >
              <div
                className={`${
                  check ? "bg-sky-400 translate-x-4" : "bg-neutral-600"
                } size-4 rounded-full transition-all ease-in-out duration-300`}
              ></div>
            </div>
          </div>
        ...
        <div className="mt-4 w-full flex justify-between items-end">
          <button className="px-6 py-0.5 bg-sky-400 rounded-lg">Save</button>
